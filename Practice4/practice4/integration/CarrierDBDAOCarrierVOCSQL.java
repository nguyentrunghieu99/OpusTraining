...
*@FileName : CarrierDBDAOCarrierVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CarrierDBDAOCarrierVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CarrierDBDAOCarrierVOCSQL(){
		setQuery();
		...
		query.append("FileName : CarrierDBDAOCarrierVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
