...
*@FileName : CarrierDBDAOCarrierVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CarrierDBDAOCarrierVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CarrierDBDAOCarrierVOUSQL(){
		setQuery();
		...
		query.append("FileName : CarrierDBDAOCarrierVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
