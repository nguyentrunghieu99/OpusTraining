...
function initSheet(sheetObj, sheetNo) {
	...
	case 1: // sheet1 init
		with (sheetObj) {
			var HeadTitle1 = "|Chk|Carrier|Rev.Lane|Vendor Code|Customer Code|Customer Code|Trade|Delete Flag|Create Date|Create User ID|Update Date|Update User ID";
			...
			var cols = [ {Type : "Status",Hidden : 1,Width : 30,Align : "Center",ColMerge : 0,SaveName : "ibflag"},{
				...
				Type : "Popup",	Hidden : 0,	Width : 70,		Align : "Center",	ColMerge : 0,SaveName : "jo_crr_cd",	KeyField : 1,CalcLogic : "",Format : "",PointCount : 0,UpdateEdit : 0,InsertEdit : 1}, {
				Type : "Combo",	Hidden : 0,	Width : 100,	Align : "Center",	ColMerge : 0,SaveName : "rlane_cd",		KeyField : 1,CalcLogic : "",Format : "",PointCount : 0,UpdateEdit : 0,InsertEdit : 1, ComboCode: rlandCombo,ComboText: rlandCombo}, {
				...
				Type : "Text",	Hidden : 0,	Width : 220,	Align : "Center",	ColMerge : 0,SaveName : "cre_dt",		KeyField : 1,CalcLogic : "",Format : "",PointCount : 0,UpdateEdit : 0,InsertEdit : 0}, {
				Type : "Text",	Hidden : 0,	Width : 225,	Align : "Right",	ColMerge : 0,SaveName : "cre_usr_id",	KeyField : 1,CalcLogic : "",Format : "",PointCount : 0,UpdateEdit : 0,InsertEdit : 0}, {
				Type : "Text",	Hidden : 0,	Width : 225,	Align : "Right",	ColMerge : 0,SaveName : "upd_dt",		KeyField : 1,CalcLogic : "",Format : "",PointCount : 0,UpdateEdit : 0,InsertEdit : 0}, {
				Type : "Text",	Hidden : 0,	Width : 220,	Align : "Center",	ColMerge : 0,SaveName : "upd_usr_id",	KeyField : 1,CalcLogic : "",Format : "",PointCount : 0,UpdateEdit : 0,InsertEdit : 0}];
			InitColumns(cols);
			SetEditable(1);
			resizeSheet();
...
function sheet1_OnSaveEnd(code,msg) {
		if(msg >= 0) {
			alert('Save Successfully'); // saving success message
			doActionIBSheet(sheetObjects[0], document.form, IBSEARCH);
			} else {
			alert('Save Failed'); // saving failure message
			}
}
...
function getTrade(rowArray) {
    ...
    var formObj=document.form;
   	...
   	sheetObj.SetCellValue(sheetObj.GetSelectRow(),7,colArray[3]);
}
...
function getVendor(rowArray) {
    ...
    var formObj=document.form;
   	var colArray=rowArray[0];
   	sheetObj.SetCellValue(sheetObj.GetSelectRow(),4,colArray[2]);
}
...
function getCustomer(rowArray) {
    ...
    var formObj=document.form;
   	...
   	sheetObj.SetCellValue(sheetObj.GetSelectRow(),6,colArray[3]);
}
...
function getCarrier(rowArray) {
    ...
    var formObj=document.form;
   	var colArray=rowArray[0];
   	sheetObj.SetCellValue(sheetObj.GetSelectRow(),2,colArray[3]);
}
...
function sheet1_OnPopupClick(Row,Col,CellX) {
	...
	}else if(CellX == 2 && sheetObjects[0].GetCellValue(sheetObjects[0].GetSelectRow(),0)=='I'){
...
//ComOpenPopup("COM_COM_0011.do", 830, 410, "setServiceLaneCode", "1,0,1,1,1,1", false, false, 0, 0, 0, "COM_COM_0011");
