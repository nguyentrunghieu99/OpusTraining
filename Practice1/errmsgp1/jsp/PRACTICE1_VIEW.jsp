...
<%@ page import="com.clt.apps.opus.esm.clv.practice1.errmsgp1.event.Practice1ViewEvent"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	Practice1ViewEvent  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	String strUsr_id		= "";
	String strUsr_nm		= "";
	Logger log = Logger.getLogger("com.clt.apps.Practice1.ErrMsgP1");
	...
	try {
		...
		event = (Practice1ViewEvent)request.getAttribute("Event");
...
<html>
<head>
<title>Practice1 Training</title>
