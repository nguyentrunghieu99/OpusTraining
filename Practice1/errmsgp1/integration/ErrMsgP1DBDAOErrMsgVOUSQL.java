...
*@FileName : ErrMsgP1DBDAOErrMsgVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ErrMsgP1DBDAOErrMsgVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ErrMsgP1DBDAOErrMsgVOUSQL(){
		setQuery();
		...
		query.append("FileName : ErrMsgP1DBDAOErrMsgVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
