...
*@FileName : ErrMsgP1DBDAOErrMsgVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ErrMsgP1DBDAOErrMsgVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ErrMsgP1DBDAOErrMsgVOCSQL(){
		setQuery();
		...
		query.append("FileName : ErrMsgP1DBDAOErrMsgVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
