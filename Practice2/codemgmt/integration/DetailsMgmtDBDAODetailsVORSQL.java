...
*@FileName : DetailsMgmtDBDAODetailsVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DetailsMgmtDBDAODetailsVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DetailsMgmtDBDAODetailsVORSQL(){
		setQuery();
		...
		query.append("FileName : DetailsMgmtDBDAODetailsVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
