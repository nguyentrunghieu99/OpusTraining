...
*@FileName : DetailsMgmtDAODeleteByCDIDDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DetailsMgmtDAODeleteByCDIDDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DetailsMgmtDAODeleteByCDIDDSQL(){
		setQuery();
		...
		query.append("FileName : DetailsMgmtDAODeleteByCDIDDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
