...
*@FileName : DetailsMgmtDBDAODetailsVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DetailsMgmtDBDAODetailsVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DetailsMgmtDBDAODetailsVOCSQL(){
		setQuery();
		...
		query.append("FileName : DetailsMgmtDBDAODetailsVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
