...
*@FileName : DetailsMgmtDBDAODetailsVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DetailsMgmtDBDAODetailsVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DetailsMgmtDBDAODetailsVOUSQL(){
		setQuery();
		...
		query.append("FileName : DetailsMgmtDBDAODetailsVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
