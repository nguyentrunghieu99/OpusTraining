...
*@FileName : CodeValidateDBDAOCodeVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeValidateDBDAOCodeVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CodeValidateDBDAOCodeVORSQL(){
		setQuery();
		...
		query.append("FileName : CodeValidateDBDAOCodeVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	COUNT(INTG_CD_ID)" ).append("\n"); 
