...
public class DetailsVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<DetailsVO> models = new ArrayList<DetailsVO>();
	...
	public DetailsVO(String ibflag, String pagerows, String updDt, String updUsrId, String creDt, String creUsrId, String aplyEndDt, String aplyStDt, String intgCdValDpSeq, String intgCdValDesc, String intgCdValDpDesc, String intgCdValCtnt, String intgCdId) {
		this.updDt = updDt;
...
/**
	 ...
	 * @return DetailsVO[]
	 */
	public DetailsVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return DetailsVO[]
	 */
	public DetailsVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		DetailsVO model = null;
	...
	public DetailsVO[] getDetailsVOs(){
		DetailsVO[] vos = (DetailsVO[])models.toArray(new DetailsVO[models.size()]);
		return vos;
	}
